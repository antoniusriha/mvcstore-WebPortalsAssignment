...
<asp:Content ContentPlaceHolderID="MainContent" ID="MainContentContent" runat="server">
	<asp:ObjectDataSource ID="CategoriesDataSource" runat="server"
        SelectMethod="GetCategories" TypeName="MvcStore.Admin.StoreProxy">
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="ProductsGridDataSource" runat="server"
		...
		<SelectParameters>
        	<asp:ControlParameter ControlID="Categories" Name="id"
